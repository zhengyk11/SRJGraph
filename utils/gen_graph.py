...
def main():
    ...
    with open('../dataset/dataset_0929/user_cate_item_table_all.pkl', 'w') as _out:
        cPickle.dump(user_cate_item_table, _out, protocol=0)
    with open('../dataset/dataset_0929/item_user_table_all.pkl', 'w') as _out:
    ...
    with open('../dataset/dataset_0929/user_cate_item_table_search.pkl', 'w') as _out:
        cPickle.dump(user_cate_item_table, _out, protocol=0)
    with open('../dataset/dataset_0929/item_user_table_search.pkl', 'w') as _out:
        cPickle.dump(item_user_table, _out, protocol=0)
    ...
    with open('../dataset/dataset_0929/user_cate_item_table_recommend.pkl', 'w') as _out:
        cPickle.dump(user_cate_item_table, _out, protocol=0)
    with open('../dataset/dataset_0929/item_user_table_recommend.pkl', 'w') as _out:
        cPickle.dump(item_user_table, _out, protocol=0)
